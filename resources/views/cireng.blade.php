...
<body>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="header__logo">
                            <a href="./index.html"><img src="img/logoh.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="resep">
            ...
            <h3 class="judulResep">Cireng Salju</h3>
            <img src="img\product\cireng.jpg" class="gambar" alt="">
            ...
            <ul>
                ...
                <li>7. Hasilnya Lumayan banyak nih.. jadi 13-15 biji tergantung ukuran dan berat adonan.</li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="img/logocoba.png" alt=""></a>
                        </div>
                        <ul>
